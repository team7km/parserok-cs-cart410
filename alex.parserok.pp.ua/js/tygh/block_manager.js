    ...
    this.initDeviceAvailabilitySwitcher = function (params)
    {
        $(params.switch_selector).each(function(i, elm) {
            ...
            $switcher.on('click', function(e) {
                ...
                // hide menus
                $(params.controls_selector).addClass('hidden');

                // disable drag'n'drop
                $(params.sortable_selector).sortable('disable');
            });
        });
        ...
        $(params.reset_selector).on('click', function(e) {
            ...
            // show menus
            $(params.controls_selector).each(function(i, menu) {
                var $menu = $(menu);
            ...
            // enable drag'n'drop
            $(params.sortable_selector).sortable('enable');
        });
