...
class Repository
{
     ...
     */
    public function findVendorProductIds($master_product_id, array $status = null, array $company_status = null)
    {
    ...
    /**
     * Finds count of vendor products.
     *
     * @param int           $master_product_id Master product ID
     * @param string[]|null $status            Status of vendor products. Set to null to disable filtering
     * @param string[]|null $company_status    Status of vendor. Set to null to disable filtering
     ...
     * @return int
     */
    public function findVendorProductsCount($master_product_id, array $status = null, array $company_status = null)
    {
        if (!$master_product_id) {
            return 0;
        }
