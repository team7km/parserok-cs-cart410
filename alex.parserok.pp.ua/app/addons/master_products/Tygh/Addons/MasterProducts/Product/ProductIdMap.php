...
class ProductIdMap
{
     ...
     */
    public function setMasterProductId($vendor_product_id, $master_product_id, $company_id)
    {
        $vendor_product_id = (int) $vendor_product_id;
        $master_product_id = (int) $master_product_id;
        $company_id = (int) $company_id;

        $this->master_product_id_map[$vendor_product_id] = $master_product_id;
        $this->company_product_id_map[$vendor_product_id] = $company_id;
    }
