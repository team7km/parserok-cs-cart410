...
<div class="table-wrapper">
    ...
    <tr id="{$comb_id}_container"
        class="cm-row-status-{$category.status|lower}{if $has_children} cm-click-on-visible{else} cm-toggle-checked{/if}{if !$cur_cat.company_categories} cm-click-and-close{/if}"
        {if $has_children}
