<?php /* Smarty version Smarty-3.1.21, created on 2019-06-23 13:17:51
         compiled from "/var/www/user01/data/www/alex.parserok.pp.ua/design/backend/templates/views/index/components/dashboard.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7454772935d0f51cf3481c7-11349103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa712b37e978c400d98d1d29fc4c56615f3f94d8' => 
    array (
      0 => '/var/www/user01/data/www/alex.parserok.pp.ua/design/backend/templates/views/index/components/dashboard.tpl',
      1 => 1561284023,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '7454772935d0f51cf3481c7-11349103',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5d0f51cf632671_69261252',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d0f51cf632671_69261252')) {function content_5d0f51cf632671_69261252($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/user01/data/www/alex.parserok.pp.ua/app/functions/smarty_plugins/block.inline_script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/user01/data/www/alex.parserok.pp.ua/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_count')) include '/var/www/user01/data/www/alex.parserok.pp.ua/app/functions/smarty_plugins/modifier.count.php';
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['pages']['total_pages']), ENT_QUOTES, 'UTF-8');?>
        ...
        <?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/user01/data/www/alex.parserok.pp.ua/app/functions/smarty_plugins/modifier.date_format.php';
...
"><?php echo $_smarty_tpl->__('show_all');?>
                        ...
                        <?php if (!is_callable('smarty_block_hook')) include '/var/www/user01/data/www/alex.parserok.pp.ua/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/user01/data/www/alex.parserok.pp.ua/app/functions/smarty_plugins/modifier.date_format.php';
