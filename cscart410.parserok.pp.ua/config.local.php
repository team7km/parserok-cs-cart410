...
$config['db_name'] = 'cscart410';
$config['db_user'] = 'xlsdb_user01';
$config['db_password'] = '0p5S3S-f[k';
...
$config['http_host'] = 'cscart410.parserok.pp.ua';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'cscart410.parserok.pp.ua';
$config['https_path'] = '';
