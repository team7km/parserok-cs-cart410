...
function fn_blog_get_pages_pre(&$params, $items_per_page, $lang_code)
{
    ...
    if (!empty($params['page_type']) && $params['page_type'] == PAGE_TYPE_BLOG
        && empty($params['parent_id']) && empty($params['is_search']) && empty($params['get_tree'])
    ) {
            $params['parent_id'] = fn_blog_get_first_blog_page_id();
        }
}
...
{
    if (!empty($params['page_type']) && $params['page_type'] == PAGE_TYPE_BLOG) {
        if (empty($params['parent_id']) && empty($params['is_search'])) {
            $params['parent_id'] = fn_blog_get_first_blog_page_id();
        }
