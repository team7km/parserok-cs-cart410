...
$schema['export_fields'][PRODUCT_VARIATION_EXIM_CODE_FIELD] = [
    ...
    'process_put'   => ['fn_product_variations_exim_set_variation_group_code', '%' . PRODUCT_VARIATION_EXIM_CODE_FIELD . '%'],
...
$schema['export_fields'][PRODUCT_VARIATION_EXIM_DEFAULT_VARIATION] = [
    ...
    'process_put'   => ['fn_product_variations_exim_set_variation_set_as_default', '%' . PRODUCT_VARIATION_EXIM_DEFAULT_VARIATION . '%'],
