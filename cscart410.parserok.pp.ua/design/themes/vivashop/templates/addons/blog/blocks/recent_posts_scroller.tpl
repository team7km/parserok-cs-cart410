...
<div class="ty-mb-l vs-blog-scroller">
            ...
            <div class="ty-blog-recent-posts-scroller__item">
                ...
                <div class="ty-blog-recent-posts-scroller__img-block">
                    <a href="{"pages.view?page_id=`$page.page_id`"|fn_url}">
                        {include file="common/image.tpl" image_width="420" image_height="142" obj_id=$page.page_id images=$page.main_pair}
                    </a>
                </div>

                <div class="clearfix">
                    <a href="{"pages.view?page_id=`$page.page_id`"|fn_url}" class="ty-float-left vs-blog-title">{$page.page}</a>

                    <div class="ty-blog__date ty-float-right vs-blog-date">{$page.timestamp|date_format:"`$settings.Appearance.date_format`"}</div>

                </div>

                {$subpage=$page.page_id|fn_get_page_data}
                <div class="vs-blog-descr">{$subpage.description|strip_tags|truncate:120:"...":true nofilter}</div>
