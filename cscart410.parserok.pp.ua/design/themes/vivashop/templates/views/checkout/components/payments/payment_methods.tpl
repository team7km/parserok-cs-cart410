...
<div class="ty-tabs cm-j-tabs cm-track cm-j-tabs-disable-convertation clearfix vs-payment-tabs">
...
<div class="cm-tabs-content tabs-content clearfix vs-payment-tabs-content">
    {foreach from=$payment_methods key="tab_id" item="payments"}
