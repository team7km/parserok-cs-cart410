...
<div class="ty-product-filters__tools clearfix">
    ...
    <a href="{$filter_base_url|fn_url}" rel="nofollow" class="ty-product-filters__reset-button cm-ajax cm-ajax-full-render cm-history reset-filters" data-ca-event="ce.filtersinit" data-ca-scroll=".ty-mainbox-title" data-ca-target-id="{$ajax_div_ids}"><i class="vs-icon-reset"></i> {__("reset")}</a>
