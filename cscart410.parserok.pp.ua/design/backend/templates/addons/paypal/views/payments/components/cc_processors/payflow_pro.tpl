...
<div id="section_technical_details">
    ...
    <div class="control-group">
        <label class="control-label cm-required" for="processor_id">{__("processor_id")}:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label cm-required" for="transaction_password">{__("transaction_password")}:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label cm-required" for="transaction_url">{__("transaction_url")}:</label>
        <div class="controls">
