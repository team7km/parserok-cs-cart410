...
<div id="content_variations">
    ...
    <form action="{""|fn_url}" method="post" name="manage_variation_products_form" id="manage_variation_products_form" data-ca-main-content-selector="[data-ca-main-content]">
            ...
            <div class="object-container product-variations__container">
                <table width="100%" class="table table-middle" data-ca-main-content>
                    ...
                    <tr>
                        ...
                        <th width="30%" class="nowrap"><span>{__("name")} / {__("sku")}</span></th>
