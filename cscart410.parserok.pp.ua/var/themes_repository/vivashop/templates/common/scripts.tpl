...
{if !$runtime.customization_mode.live_editor}
    {if $language_direction == 'rtl'}
        {script src="design/themes/{$settings.theme_name}/js/tooltip.min.js"}
    {else}
    {script src="js/lib/tools/tooltip.min.js"}
    {/if}
{/if}

{script src="design/themes/vivashop/js/vs-responsive.js"}

{script src="design/themes/vivashop/js/vs.js"}
