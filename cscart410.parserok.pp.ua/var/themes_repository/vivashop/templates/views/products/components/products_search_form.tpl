...
{/hook}
<div class="ty-control-group vs-search-in-category">
...
{if !$simple_search_form}
    ...
    <div class="ty-control-group">
        ...
        <input type="text" name="price_from" id="price_from" value="{$search.price_from}" onfocus="this.select();" class="ty-search-form__input" size="30" /><span class="vs-search-range">&nbsp;-&nbsp;</span><input type="text" name="price_to" value="{$search.price_to}" onfocus="this.select();" class="ty-search-form__input" size="30" />
    </div>
    ...
    <div class="ty-control-group">
        ...
        <input type="text" name="weight_from" id="weight_from" value="{$search.weight_from}" onfocus="this.select();" class="ty-search-form__input" size="30" /><span class="vs-search-range">&nbsp;-&nbsp;</span><input type="text" name="weight_to" value="{$search.weight_to}" onfocus="this.select();" class="ty-search-form__input" size="30" />
    </div>
{/if}

<div class="ty-search-form__buttons-container buttons-container">
    {include file="buttons/search.tpl" but_name="dispatch[`$dispatch`]"}&nbsp;{__("or")}&nbsp;&nbsp;<a class="text-button cm-reset-link">{__("reset")}</a>
</div>
