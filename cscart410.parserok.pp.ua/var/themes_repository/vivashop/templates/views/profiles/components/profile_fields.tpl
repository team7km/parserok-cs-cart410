...
{if $address_flag}
    <div class="ty-profile-field__switch ty-address-switch clearfix">
        <div class="ty-float-left ty-profile-field__switch-label"><span>{if $section == "S"}{__("shipping_same_as_billing")}{else}{__("text_billing_same_with_shipping")}{/if}</span></div>
        <div class="ty-float-right ty-profile-field__switch-actions">
