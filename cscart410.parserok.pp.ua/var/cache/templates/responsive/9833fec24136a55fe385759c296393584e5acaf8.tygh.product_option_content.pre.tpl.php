<?php /* Smarty version Smarty-3.1.21, created on 2019-06-16 14:49:25
         compiled from "/var/www/user01/data/www/cscart410.parserok.pp.ua/design/themes/responsive/templates/addons/product_variations/hooks/products/product_option_content.pre.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14113023965d062cc58c2357-22312383%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9833fec24136a55fe385759c296393584e5acaf8' => 
    array (
      0 => '/var/www/user01/data/www/cscart410.parserok.pp.ua/design/themes/responsive/templates/addons/product_variations/hooks/products/product_option_content.pre.tpl',
      1 => 1560684662,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14113023965d062cc58c2357-22312383',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d062cc59f0e06_51437700',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d062cc59f0e06_51437700')) {function content_5d062cc59f0e06_51437700($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/user01/data/www/cscart410.parserok.pp.ua/app/functions/smarty_plugins/function.script.php';
...
?>
                            ...
                            <?php } ?>
                        <?php } elseif ($_smarty_tpl->tpl_vars['feature']->value['feature_style']===$_smarty_tpl->tpl_vars['feature_style_dropdown']->value) {?>
...
"
                                   class="ty-product-options__image--wrapper <?php if ($_smarty_tpl->tpl_vars['variant']->value['variant_id']==$_smarty_tpl->tpl_vars['feature']->value['variant_id']) {?>ty-product-options__image--wrapper--active<?php }?> <?php if ($_smarty_tpl->tpl_vars['quick_view']->value) {?>cm-ajax cm-ajax-cache<?php }?>"
                                   <?php if ($_smarty_tpl->tpl_vars['quick_view']->value) {?>data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['container']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?>
                                >
