<?php /* Smarty version Smarty-3.1.21, created on 2019-06-16 13:58:40
         compiled from "/var/www/user01/data/www/cscart410.parserok.pp.ua/design/backend/templates/views/block_manager/update_block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11124556295d0620e01a7b47-57998912%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfd0ec57436c9cf3b0ae989b7fb72245ce3b1969' => 
    array (
      0 => '/var/www/user01/data/www/cscart410.parserok.pp.ua/design/backend/templates/views/block_manager/update_block.tpl',
      1 => 1560353848,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11124556295d0620e01a7b47-57998912',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d0620e036a8b5_53332076',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d0620e036a8b5_53332076')) {function content_5d0620e036a8b5_53332076($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/user01/data/www/cscart410.parserok.pp.ua/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_include_ext')) include '/var/www/user01/data/www/cscart410.parserok.pp.ua/app/functions/smarty_plugins/function.include_ext.php';
?><?php
...
"></i>
            ...
            <div class="hidden">
                <?php ob_start();
echo htmlspecialchars(fn_encrypt_text(((string)$_smarty_tpl->tpl_vars['id']->value).":".((string)$_smarty_tpl->tpl_vars['snapping_id']->value)), ENT_QUOTES, 'UTF-8');
$_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['code'] = new Smarty_variable("<div class='cm-block-loader' data-ca-object-key='".$_tmp1."'></div>", null, 0);?>
                <pre><code><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['code']->value, ENT_QUOTES, 'UTF-8');?>
</code></pre>
            </div>
            <?php }?>
        </div>
