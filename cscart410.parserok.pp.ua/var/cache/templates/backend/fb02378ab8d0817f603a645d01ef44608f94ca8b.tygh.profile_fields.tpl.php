<?php /* Smarty version Smarty-3.1.21, created on 2019-06-15 20:58:33
         compiled from "/var/www/user01/data/www/cscart410.parserok.pp.ua/design/backend/templates/views/profiles/components/profile_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17861981805d0531c94a6297-06421709%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb02378ab8d0817f603a645d01ef44608f94ca8b' => 
    array (
      0 => '/var/www/user01/data/www/cscart410.parserok.pp.ua/design/backend/templates/views/profiles/components/profile_fields.tpl',
      1 => 1560353872,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17861981805d0531c94a6297-06421709',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d0531c963a727_60425862',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d0531c963a727_60425862')) {function content_5d0531c963a727_60425862($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/user01/data/www/cscart410.parserok.pp.ua/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['field']->value['field_name']&&$_smarty_tpl->tpl_vars['field']->value['is_default']=="Y") {?>
    ...
    <?php if (in_array($_smarty_tpl->tpl_vars['field']->value['field_name'],array("s_city","b_city"))) {?>
        <?php $_smarty_tpl->createLocalArrayVariable('field', null, 0);
$_smarty_tpl->tpl_vars['field']->value['required'] = "Y";?>
    <?php }?>
<?php } else { ?>
