<?php /* Smarty version Smarty-3.1.21, created on 2019-06-16 12:55:49
         compiled from "/var/www/user01/data/www/cscart410.parserok.pp.ua/design/backend/templates/common/select2_categories_bulkedit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18215007845d0612259ce2a1-67118763%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49aa9dfddd27ee2b1c5c5693dd308effdb994b32' => 
    array (
      0 => '/var/www/user01/data/www/cscart410.parserok.pp.ua/design/backend/templates/common/select2_categories_bulkedit.tpl',
      1 => 1560353831,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18215007845d0612259ce2a1-67118763',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'select2_bulk_edit_mode' => 0,
    'select2_bulk_edit_mode_category_ids' => 0,
    'category_ids' => 0,
    'category_id' => 0,
    'runtime' => 0,
  ),
  ...
  'unifunc' => 'content_5d061225a91d80_45606211',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d061225a91d80_45606211')) {function content_5d061225a91d80_45606211($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/user01/data/www/cscart410.parserok.pp.ua/app/functions/smarty_plugins/function.script.php';
?><?php
...
"
        data-ca-bulk-edit-mode="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['select2_bulk_edit_mode']->value)===null||$tmp==='' ? "false" : $tmp), ENT_QUOTES, 'UTF-8');?>
"
        <?php if ($_smarty_tpl->tpl_vars['select2_bulk_edit_mode']->value) {?>
            data-ca-bulk-edit-mode-category-ids="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['select2_bulk_edit_mode_category_ids']->value), ENT_QUOTES, 'UTF-8');?>
"
        <?php }?>
    >
...
" 
                        selected="selected"
                        <?php if ($_smarty_tpl->tpl_vars['select2_bulk_edit_mode']->value) {?>
                            data-ca-state="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['select2_bulk_edit_mode_category_ids']->value[$_smarty_tpl->tpl_vars['category_id']->value]['status'], ENT_QUOTES, 'UTF-8');?>
"
                        <?php }?>
                ></option>
            <?php } ?>
