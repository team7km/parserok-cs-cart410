                                ...
                                {foreach $sprivilege as $p}
                                    {if $p && $p.description}
                                        ...
                                        <td width="1%" class="table-group-checkbox">
                                            <input type="checkbox" name="usergroup_data[privileges][{$pr_id}]" value="Y" {if $usergroup_privileges.$pr_id}checked="checked"{/if} class="checkbox  cm-item-privilege-check-{$section_id}-{$usergroup_id}" id="set_privileges_{$id}_{$pr_id}"/></td>
