...
$schema = [
    'products'                      => MainTable::create('products', 'product_id', ['product_type', 'parent_product_id', 'master_product_id', 'master_product_status', 'timestamp', 'updated_timestamp', 'company_id']),
