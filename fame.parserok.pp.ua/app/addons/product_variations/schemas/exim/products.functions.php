...
function fn_product_variations_exim_set_variation_group_code($variation_group_code)
{
    return trim($variation_group_code);
}
...
function fn_product_variations_exim_set_variation_set_as_default($variation_set_as_default)
{
    return trim($variation_set_as_default);
}