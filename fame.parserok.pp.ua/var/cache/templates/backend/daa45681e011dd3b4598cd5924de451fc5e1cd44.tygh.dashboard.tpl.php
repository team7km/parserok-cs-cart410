<?php /* Smarty version Smarty-3.1.21, created on 2019-06-23 15:12:42
         compiled from "/var/www/user01/data/www/fame.parserok.pp.ua/design/backend/templates/views/index/components/dashboard.tpl" */ ?>
<?php /*%%SmartyHeaderCode:201039565d0f6cba4b7225-23441183%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'daa45681e011dd3b4598cd5924de451fc5e1cd44' => 
    array (
      0 => '/var/www/user01/data/www/fame.parserok.pp.ua/design/backend/templates/views/index/components/dashboard.tpl',
      1 => 1561288222,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '201039565d0f6cba4b7225-23441183',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5d0f6cba7df312_74808648',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d0f6cba7df312_74808648')) {function content_5d0f6cba7df312_74808648($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/user01/data/www/fame.parserok.pp.ua/app/functions/smarty_plugins/block.inline_script.php';
...
if (!is_callable('smarty_modifier_count')) include '/var/www/user01/data/www/fame.parserok.pp.ua/app/functions/smarty_plugins/modifier.count.php';
if (!is_callable('smarty_modifier_enum')) include '/var/www/user01/data/www/fame.parserok.pp.ua/app/functions/smarty_plugins/modifier.enum.php';
?><?php
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['pages']['total_pages']), ENT_QUOTES, 'UTF-8');?>
        ...
        <?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/user01/data/www/fame.parserok.pp.ua/app/functions/smarty_plugins/modifier.date_format.php';
...
"><?php echo $_smarty_tpl->__('show_all');?>
                        ...
                        <?php if (!is_callable('smarty_block_hook')) include '/var/www/user01/data/www/fame.parserok.pp.ua/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/user01/data/www/fame.parserok.pp.ua/app/functions/smarty_plugins/modifier.date_format.php';
